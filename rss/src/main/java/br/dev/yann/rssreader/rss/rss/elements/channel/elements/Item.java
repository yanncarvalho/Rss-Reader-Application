...
import br.dev.yann.rssreader.rss.rss.elements.channel.elements.item.elements.Enclosure;
import br.dev.yann.rssreader.rss.rss.elements.channel.elements.item.elements.Guid;
...
public class Item {
    ...
    public String toString() {
      return "Item [title=" + title + ", link=" + link + ", descript=" + descript + ", author=" + author + ", comments="
          + comments + ", description=" + description + ", enclosure=" + enclosure + ", guid=" + guid + ", pubDate="
          + pubDate + ", source=" + source + ", categories=" + categories + "]";
    }
