...
public class RssRepository {
	...
	/**
	 * Update or Insert in the database a List of Rss.
	 *
	 * @param listRss Rss to be inserted or updated wrapped in a {@link List}.
	 */
	...
	public @Nullable Rss findByUrl(String url) {
		...
		return collection.findOne(query, Rss.class);
	}
}
