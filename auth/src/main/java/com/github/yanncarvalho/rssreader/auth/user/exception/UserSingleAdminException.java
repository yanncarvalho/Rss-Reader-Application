...
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.EXCEPTION_SINGLE_USER_ADMIN;
...
public class UserSingleAdminException  extends RuntimeException{
	 ...
	 * {@link com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue#EXCEPTION_SINGLE_USER_ADMIN default message}.
	 */
