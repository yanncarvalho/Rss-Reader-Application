...
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.NAME_PATTERN;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.NAME_PATTERN_ERROR_MSG;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.SIZE_FIELD_MAX;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.SIZE_FIELD_MIN;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.SIZE_USER_USERNAME_MAX;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.START_WITH_LETTERS_PATTERN;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.START_WITH_LETTERS_PATTERN_ERROR_MSG;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.SWAGGER_NAME_DESCRIPTION;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.SWAGGER_USERNAME_DESCRIPTION;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.USERNAME_PATTERN;
import static com.github.yanncarvalho.rssreader.auth.configuration.DefaultValue.USERNAME_PATTERN_ERROR_MSG;
...
public record UpdateAsAdminReq(
	...
	/**Representantion of {@link com.github.yanncarvalho.rssreader.auth.user.User#role role} */
	@NotNull
